                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>StyleCart </p>
                            </td>
                            <td>30%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>Flipkart </p>
                            </td>
                            <td>10%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>Snapdeal </p>
                            </td>
                            <td>20%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>Paytm </p>
                            </td>
                            <td>15%</td>
                          </tr>
                          <tr>
                  ...
                  <div class="dashboard-widget-content">
                    ...
                    <div class="sidebar-widget">
                      ...
                      <div class="goal-wrapper">
                        ...
                        <span id="gauge-text" class="gauge-value pull-left">25</span>
                        <span id="goal-text" class="goal-value pull-right">48</span>
                      </div>
                    </div>
                  </div>
                </div>
