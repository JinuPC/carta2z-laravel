                    ...
                    <table id="datatable-buttons" class="table table-hover table-striped table-bordered">
                      ...
                      @foreach ($purchases as $purchase)
                        <tr>
                          ...
                          <td style="text-align:center;"><h4>{{$purchase->retailer}}</h4></td>
                          <td style="text-align:center;"><h4>{{$purchase->status}}</h4></td>
                          <td style="text-align:center;">
                            @if ($purchase->finished == 5)
                              <h4><span class="label label-info">New Return</span></h4>
                            @elseif($purchase->finished == 6)
                              <h4><span class="label label-info">Return Approved</span></h4>
                            @elseif($purchase->finished == 7)
                              <h4><span class="label label-info">Return Processing</span></h4>
                            @elseif($purchase->finished == 8)
                          ...
                          <td style="text-align:center;">
                            ...
                            {!! Form::open([
                              ...
                              <!-- Small modal -->
                                ...
                                <a href="{{url('/')}}/admin/purchases/view/{{$purchase->id}}" type="button" class="btn inline btn-info" ><span data-toggle="tooltip" title="View Details " class="glyphicon glyphicon-thumbs-up"></span></a>
                                  ...
                                  <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-header">
                                        ...
                                        <h4 style="text-align:center;" class="modal-title" id="myModalLabel2">Update purchase Status</h4>
                                      </div>
